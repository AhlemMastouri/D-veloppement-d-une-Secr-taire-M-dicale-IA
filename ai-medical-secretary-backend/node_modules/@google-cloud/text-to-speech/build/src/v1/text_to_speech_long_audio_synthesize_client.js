 ...
 * `src/v1/text_to_speech_long_audio_synthesize_client_config.json`.
...
class TextToSpeechLongAudioSynthesizeClient {
    ...
    initialize() {
        ...
        this.textToSpeechLongAudioSynthesizeStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.texttospeech.v1.TextToSpeechLongAudioSynthesize')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.texttospeech.v1
